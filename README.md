...
* Multi-pipe transfers: configurable USB and WiFi streams for higher sustained throughput on capable devices.
...
& $CXX -O2 -static -static-libstdc++ -std=c++17 -march=armv8-a+crc `
