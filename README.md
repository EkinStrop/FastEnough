...
Pre-built signed releases are published at [EkinStrop/FastEnough-Releases](https://github.com/EkinStrop/FastEnough-Releases). This repository contains the source.
...
Issues and pull requests are welcome. Please avoid em dashes in any text files (project convention).
